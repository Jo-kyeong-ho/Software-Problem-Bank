...
public class mypage extends JFrame {
	...
	/*
	 * gui of mypage that contain various data of user.
	 */
	...
	String input;
	public mypage(Socket socket1,String input) {
		...
		JButton btnGame = new JButton("게임하기");
		btnGame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				out.println("Msgplaygame");
				setVisible(false);
			}
		});
		btnGame.setForeground(Color.BLACK);
		btnGame.setBackground(Color.WHITE);
		btnGame.setBounds(0, 367, 120, 47);
		menu.add(btnGame);
		...
		btnUpdate.setForeground(new Color(196, 237, 255));
		btnUpdate.setBackground(new Color(10,140,201));
		...
		btnMyquestion_1.setForeground(new Color(196, 237, 255));
		btnMyquestion_1.setBackground(new Color(10,140,201));
		btnMyquestion_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				out.println("Msgmyquestion/1");
				setVisible(false);
			}
		});
		...
		btnMyanswer.setForeground(new Color(196, 237, 255));
		btnMyanswer.setBackground(new Color(10,140,201));
		btnMyanswer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				out.println("Msgmyanswer");
				setVisible(false);
			}
		});
		...
		btnMyupload.setForeground(new Color(196, 237, 255));
		btnMyupload.setBackground(new Color(10,140,201));
		btnMyupload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				out.println("Msgmyproblem/1");
				setVisible(false);
			}
		});
